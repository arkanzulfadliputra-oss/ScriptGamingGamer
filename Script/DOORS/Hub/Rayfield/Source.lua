...
-- === Make TabList horizontally scrollable ===
do
	if TabList:IsA("ScrollingFrame") then
		...
		TabList.ScrollBarImageColor3 = RayfieldLibrary.Theme.Default.TextColor
	else
		...
		scrollFrame.ScrollBarImageColor3 = RayfieldLibrary.Theme.Default.TextColor
		...
		scrollFrame.Parent = TabList

		-- Move existing children (Template, UIListLayout, UIPadding, etc.) into the scroll frame
		...
		-- Reassign TabList to the scroll frame so all existing code works
		TabList = scrollFrame
	end
end
...
local function ChangeTheme(Theme)
	...
	-- Update TabList scrollbar color when theme changes
	if TabList and TabList:IsA("ScrollingFrame") then
		TabList.ScrollBarImageColor3 = SelectedTheme.TextColor
	end

	-- Update TabPage scrollbar colors when theme changes
	for _, TabPage in ipairs(Elements:GetChildren()) do
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	function Window:CreateTab(Name, Image, Ext)
		...
		-- Ensure vertical scrolling works properly with automatic canvas size
		TabPage.ScrollingDirection = Enum.ScrollingDirection.Y
		TabPage.AutomaticCanvasSize = Enum.AutomaticSize.Y
		TabPage.CanvasSize = UDim2.new(0, 0, 0, 0)
		TabPage.ScrollBarThickness = 3
		TabPage.ScrollBarImageTransparency = 0.5
		TabPage.ScrollBarImageColor3 = RayfieldLibrary.Theme.Default.TextColor
