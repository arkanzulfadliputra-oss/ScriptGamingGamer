...
local Tab = Window:CreateTab("Spawner Custom Entities", 11631793705) -- Title, Image
...
local Label = Tab:CreateLabel("Version 1.0", 4483362458, Color3.fromRGB(255, 255, 255), false) -- Title, Icon, Color, IgnoreTheme
